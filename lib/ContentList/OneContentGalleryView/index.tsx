...
const OneContentGalleryView = ({
  ...
  return (
    <button
      className="flex flex-col items-center justify-between cursor-pointer w-fit min-h-full max-h-[336px] sm:max-w-[300px] max-w-[200px] overflow-hidden border border-white rounded-lg"
      onClick={() => {
