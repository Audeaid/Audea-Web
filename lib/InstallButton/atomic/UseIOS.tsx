...
export function UseIOS({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  const ref = useRef<SheetRef>()

  return (
    <Sheet isOpen={isOpen} onClose={onClose} ref={ref}>
      <Sheet.Container className={cn('bg-card text-card-foreground select-none')}>
        <Sheet.Header>
          <button className='w-fit h-fit' onClick={onClose}>
            <FontAwesomeIcon icon={faX} size='lg' />
          </button>
          <h1 className='font-bold text-2xl'>Install Audea PWA in iOS</h1>
        </Sheet.Header>
        <Sheet.Content>
            ...
            <div className='flex flex-col gap-14 px-8 pb-4'>
              <div className='flex flex-col gap-4'>
                <h2 className='text-xl'>
                  ...
                  on the bottom of this browser (<span className='font-bold'>Safari</span>
                  ).
                </h2>
              ...
              <div className='flex flex-col gap-4'>
                <h2 className='text-xl'>
                  <span className='font-bold'>2.</span> Scroll down until you find &quot;Add to Home Screen&quot;,
                  marked with an icon{' '}
                  <svg
                    width='37'
                    height='38'
              ...
              <div className='flex flex-col gap-4'>
                <h2 className='text-xl'>
                  <span className='font-bold'>3.</span> Finally, just press the &quot;Add&quot; button.
                </h2>
...
const FloatingIOS = () => {
  return (
    <div className='rounded-xl w-fit h-fit mx-auto pointer-events-none absolute left-0 bottom-0 right-0 flex flex-col items-center justify-center gap-y-6 px-6 pb-4 text-center z-20 bg-card text-card-foreground border-2 border-border'>
