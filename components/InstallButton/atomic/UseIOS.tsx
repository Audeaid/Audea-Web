...
const FloatingIOS = () => {
  return (
    <div className="rounded-xl w-fit h-fit mx-auto pointer-events-none absolute left-0 bottom-0 right-0 flex flex-col items-center justify-center gap-y-6 px-6 pb-4 text-center z-20">
