...
export default function Login() {
  ...
  return (
    <motion.main className='min-w-screen min-h-screen select-none' initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      <header className='w-full h-fit flex justify-between items-center md:px-8 px-4 md:py-8 py-4'>
        ...
        <Link href='/signup' className={cn(buttonVariants({ variant: 'ghost', size: 'sm' }))}>
          Sign up
        </Link>
      </header>
