...
export async function GET(req: NextRequest) {
  ...
  if (!firstName || !lastName) throw new Error('Error generating image');
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Hey, {firstName} {lastName}👋! You have been invited to use Audea.
        </div>
        ...
        >
          The invitation comes from {invitedFirstName} {invitedLastName}
        </div> */}
      </div>
    ),
    {
