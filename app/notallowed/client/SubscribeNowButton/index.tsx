...
const SubscribeNowButton = ({ subscriptionType, stripeCustomerId, clerkUserId }: ISubscribeNowButton) => {
  return (
    <section className='flex flex-col gap-8'>
      <section className='flex flex-col gap-2'>
        <h1 className='font-bold text-4xl'>
          Your {subscriptionType === 'MONTHLY' || subscriptionType === 'YEARLY' ? 'subscription' : 'free trial'} is
          over.
        </h1>
        <p className='font-light text-xl text-gray-400'>
          ...
          if you&apos;d like to continue using Audea to convert your messy thoughts into a structured notes.
        </p>
      </section>
