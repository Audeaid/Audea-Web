...
interface IRestartTrial {
  router: AppRouterInstance
  token: string
}

const RestartTrial = ({ router, token }: IRestartTrial) => {
  ...
  return (
    <section className='flex flex-col gap-2'>
      ...
      <p className='font-light text-base text-gray-400 text-center'>
        <span className='font-bold'>One time offer</span>: Since you didn&apos;t end up using Audea much during your
        initial trial, you can restart your trial and get a fresh 7 days.
      </p>
    </section>
  )
}
