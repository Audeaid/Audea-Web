...
export default function ShareToPublic({
  ...
  const [currentAction, setCurrentAction] = useState(
    sharedContent === null ? 'initial' : 'published'
  );
  ...
  const [username, setUsername] = useState(
    sharedContent === null ? '' : sharedContent.username
  );

  const [generatedId, setGeneratedId] = useState(
    sharedContent === null
      ? generateFiveRandomChar()
      : sharedContent.generatedId
  );
            ...
            return (
              <section className="w-full h-fit flex flex-col items-center justify-center text-center gap-4 mt-4">
                ...
                <p className="text-muted-foreground">
                  Publish a static website of this note. You can allow others to
                  view, and comment.
                </p>
            ...
            return (
                      ...
                      if (searchUsername !== null) {
                        ...
                        toast
                          ...
                          .then(() => {
                            toast
                              .promise(
                                createSharedContent({ token, contentId }),
                                {
              ...
              >
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    Your username should be an{' '}
                    <strong>
                      alpha-numeric (a-z, A-Z, 0-9) characters only
                    </strong>
                    . Your username will be shown on your public note like this:{' '}
