...
export default function OneContentGalleryView({ contentId, title, date, gptGenerated }: Props) {
  return (
    <a
    ...
    >
      ...
      <section className='flex flex-col w-full h-fit items-start justify-center gap-0 px-2 py-4 bg-primary text-primary-foreground border-2 border-ring rounded-b-lg'>
        ...
        <p className='font-light text-base'>{moment(date).format('MMMM DD, YYYY HH:mm')}</p>
      </section>
    </a>
  )
}
