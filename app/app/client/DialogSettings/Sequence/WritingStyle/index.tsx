...
export function WritingStyle({ value, setValue, saved, setSaved }: Props) {
  ...
  return (
    <section className='flex flex-col gap-8'>
      <p>
        Make the AI to write in any style you want. You can go crazy customizing it, you can also choose our presets,
        or, you can just use the default writing style.
      </p>
      ...
      <section className='flex flex-col gap-4'>
        ...
        <RadioGroup
          ...
          className={cn(val === 'custom' ? 'flex items-center gap-2' : 'grid gap-2')}
        >
