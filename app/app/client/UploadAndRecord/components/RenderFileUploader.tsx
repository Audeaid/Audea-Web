    ...
    >
      {currentlyDragging && (
        <section className='absolute inset-0 w-full h-full bg-yellow-500 rounded-xl flex items-center justify-center'>
          <p className='text-center text-yellow-900 text-2xl font-bold'>
      ...
      <section className='w-fit h-fit max-w-[400px] mx-auto flex flex-col gap-8'>
        <section className='flex flex-col gap-2'>
          <label className='text-xl font-medium cursor-pointer' htmlFor='file_input'>
            Upload file
          </label>
          <input
        ...
        <p className='text-xl font-medium text-center'>Drag and drop an audio file here</p>
      </section>
    </section>
  )
}
