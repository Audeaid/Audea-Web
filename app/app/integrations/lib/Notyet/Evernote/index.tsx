...
export default function Evernote({ token, initialState }: { token: string; initialState: boolean }) {
      ...
      <CardHeader>
        <CardTitle className={cn('flex items-center justify-between')}>
          <div className='flex items-center gap-4'>
            <Image src={EvernoteImage} quality={100} draggable={false} height={40} width={40} alt='Evernote logo' />
            Evernote
          </div>
