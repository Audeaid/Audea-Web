...
export default function Obsidian({ token, initialState }: { token: string; initialState: boolean }) {
      ...
      <CardHeader>
        <CardTitle className={cn('flex items-center justify-between')}>
          <div className='flex items-center gap-4'>
            <Image src={ObsidianImage} quality={100} draggable={false} height={40} width={40} alt='Obsidian logo' />
            Obsidian
          </div>
