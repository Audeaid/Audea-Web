...
export default function Whatsapp({ token, initialState }: { token: string; initialState: boolean }) {
      ...
      <CardHeader>
        <CardTitle className={cn('flex items-center justify-between')}>
          <div className='flex items-center gap-4'>
            <Image src={WhatsappImage} quality={100} draggable={false} height={40} width={40} alt='Whatsapp logo' />
            Whatsapp
          </div>
