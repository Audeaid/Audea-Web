...
export default function OutputLanguage({
  token,
  initialValue,
}: {
  token: string;
  ...
  const [value, setValue] = useState(
    outputLanguageListWithAsk.find(({ db }) => initialValue === db)?.value ?? ''
  );
                ...
                {outputLanguageListWithAsk.map((language) => (
                  <CommandItem
                    ...
                    onSelect={(currentValue) => {
                      ...
                      const db = outputLanguageListWithAsk.find(
