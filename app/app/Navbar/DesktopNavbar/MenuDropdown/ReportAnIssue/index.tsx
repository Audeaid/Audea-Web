    ...
    >
      <DialogContent className="sm:max-w-[425px] select-none">
        <DialogHeader>
          ...
          <DialogDescription>
            What area are you having problems with? Please gives us as much
            information as possible. Please also beware of sensitive
            information.
          </DialogDescription>
        </DialogHeader>
        <form
        ...
        {issueSubmitted && (
          <Alert>
            ...
            <AlertDescription>
              You&apos;ll get confirmation email shortly. And the Audea team
              will get in touch!
            </AlertDescription>
          </Alert>
        )}
