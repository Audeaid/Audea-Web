...
export const subscriptionPrices: ISubscriptionPrices[] = [
  {
    id:
      process.env.NODE_ENV === 'production'
        ? 'price_1NMJN8CqUvWtrfobxSLqofcO'
        : 'price_1NLt1oCqUvWtrfobAGHFCdOG',
  ...
  },
  {
    id:
      process.env.NODE_ENV === 'production'
        ? 'price_1NMJNRCqUvWtrfobl5EarXeW'
        : 'price_1NMBhECqUvWtrfobBVTgCw7l',
  ...
  },
  {
    id:
      process.env.NODE_ENV === 'production'
        ? 'price_1NMJNqCqUvWtrfobKIDRdMhh'
